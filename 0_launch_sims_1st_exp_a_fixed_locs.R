...
## written by aoz
## 2020JAN06
## source('/homes/azimmer/tmb_inla_comp/0_launch_sims_1st_exp_fixed_locs.R')
...
TRIAL 24: fixing locations for each iteration'
...
extra.job.name <- 'study01trial24_fixed_locs'
################################################################################
